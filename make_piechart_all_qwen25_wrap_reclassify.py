# ============================================================
# make_piechart_all_qwen25_wrap_reclassify.py
# ============================================================
# Pie chart for the Qwen2.5-VL all-entries wrap-around
# reclassification test (outputs_step8_wrap_reclassify_all_qwen25)
# — tests what the Qwen2.5-VL victim pipeline's overall
# hallucination rate would have been if the wrap-around Step 8
# prompt (short CAUTION before the ORIGINAL unchanged instructions,
# short REMINDER after) had been used from the very start, using
# the EXACT SAME existing images for every entry (Steps 1-7
# untouched).
#
# Shows the NEW TARGETED / UNTARGETED / NONE breakdown, directly
# comparable to the original combined Qwen2.5-VL pie chart.
#
# Saves the chart to:
#   outputs_step8_wrap_reclassify_all_qwen25/piechart_all_qwen25_wrap_reclassify.png
#
...
STATE_PATH = "outputs_step8_wrap_reclassify_all_qwen25/entry_state.json"
CHART_PATH = ("outputs_step8_wrap_reclassify_all_qwen25/"
              "piechart_all_qwen25_wrap_reclassify.png")
...
ax.set_title(
    ...
    f"Victim (rewrapped): Qwen2.5-VL 7B  |  Judge: Gemma-4-abliterated\n"
    f"Same entries, same existing images (Steps 1-7 untouched)\n"
