# ============================================================
# ever_hallucinated_report_till_440_qwen25.py
# ============================================================
# Combines all SIX Qwen2.5-VL victim-model batches:
...
# Gemma-victim reports. For the four reuse-method batches, there is
...
#
# Writes: Ever_hallucinated_report_till_440_qwen25.txt
# ============================================================
...
REPORT_PATH = "Ever_hallucinated_report_till_440_qwen25.txt"
...
lines.append("outputs_victim_qwen_151_200 + outputs_victim_qwen_201_280 + "
              "outputs_victim_qwen_281_360 +")
lines.append("outputs_victim_qwen_361_440")
lines.append("")
lines.append("NOTE: outputs_victim_qwen_151_200, outputs_victim_qwen_")
lines.append("201_280, outputs_victim_qwen_281_360, and outputs_victim_")
lines.append("qwen_361_440 used the 'reuse'")
lines.append("method — Steps 1-7 images/")
