# ============================================================
# pipeline_strict_batch_801_850.py — Strict Pipeline, Lines 801-850
# ============================================================
# Scans lines 801-850 of qa_data.json for human-celebrity entries —
...
# abstract facts. 38 qualifying entries were found; trimmed to the
...
#
# Output directory: outputs_strict_batch_801_850
# ============================================================
...
# entries identified within lines 801-850 (trimmed down from 38
# originally found, dropping the 8 most obscure/moderate ones to
# match the requested batch size of 30).
#
#   line#(1-idx) -> subject
#   801 -> Mick Woodmansey / David Bowie (musicians)
#   802 -> Lee Hong-gi (singer)
#   804 -> Leigh Silverman (director)
#   805 -> George Anthony David Haygarth (actor)
#   806 -> Donovan (musician)
#   807 -> Alexandra Daddario (actress)
#   808 -> William the Conqueror / Rollo (historical figures)
#   809 -> Ralph Tresvant / Chad Smith (musicians)
#   811 -> Augusto Solari (footballer)
#   812 -> Dan Castellaneta (voice actor)
#   813 -> Jordan Fisher (actor/singer)
#   814 -> Bruce Dayton / George Dayton (historical businessmen)
#   817 -> Edmond Halley / John Flamsteed (historical astronomers)
#   818 -> Judith Guest (author)
#   820 -> Danny Shirley / James Dean Bradfield (musicians)
#   821 -> Tomo Miličević (musician)
#   822 -> Katie Cassidy (actress)
#   824 -> Debbie Macomber (author)
#   826 -> Jean Michel Schlumberger (historical jewelry designer)
#   830 -> Joe Joyce (boxer)
#   831 -> K. R. Kaushik / Narendra Modi (politicians)
#   832 -> Martha Stewart
#   835 -> Anne Clarissa Eden / Anthony Eden (historical figures)
#   837 -> Hozier (musician)
#   838 -> Dan Boren / Jim Wilson (politicians)
#   839 -> William Shakespeare (via Julius Caesar entry)
#   840 -> Frederic de Hoffmann / Edward Teller (historical physicists)
#   842 -> Pam Ferris (actress)
#   846 -> Disha Patani (actress)
#   848 -> Tanya Donelly / Trace Cyrus (musicians)
BATCH_INDICES = [
    801, 802, 804, 805, 806, 807, 808, 809, 811, 812, 813, 814,
    817, 818, 820, 821, 822, 824, 826, 830, 831, 832, 835, 837,
    838, 839, 840, 842, 846, 848
]

BASE_OUTPUT_DIR = "outputs_strict_batch_801_850"
...
print(f"\n{'='*65}")
print(f"PIPELINE_STRICT_BATCH_801_850 COMPLETE — {total_time:.1f}s this run")
print(f"{'='*65}")
for r in results:
    print(
...
report_lines = [
    "="*65,
    "PIPELINE_STRICT_BATCH_801_850 — FINAL REPORT",
    "="*65,
