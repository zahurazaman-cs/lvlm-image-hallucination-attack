...
# ============================================================
# Combines FINAL-ITERATION results from ALL SEVEN strict batch runs:
...
#
# Saves the chart to:
#   outputs_strict_batch_441_520/combined_hallucination_pie_chart.png
#
...
CHART_PATH            = "outputs_strict_batch_441_520/combined_hallucination_pie_chart.png"
...
# ── Load and combine all seven batches ─────────────────────────
...
ax.set_title(
    ...
    f"(28 + 23 + 26 + 48 + 50 + 50 + 49 entries across seven batches, "
    f"{skipped} skipped)\n"
