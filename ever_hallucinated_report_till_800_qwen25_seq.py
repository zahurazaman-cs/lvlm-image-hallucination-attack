# ============================================================
# ever_hallucinated_report_till_800_qwen25_seq.py
# ============================================================
# Combines all TWELVE Qwen2.5-VL victim-model batches:
...
# Gemma-victim reports. For the ten reuse-method batches, there is
...
#
# Writes: Ever_hallucinated_report_till_800_qwen25_seq.txt
# ============================================================
...
REPORT_PATH = "Ever_hallucinated_report_till_800_qwen25_seq.txt"
...
lines.append("outputs_victim_qwen_601_650_reuse + outputs_victim_qwen_651_700 + "
              "outputs_victim_qwen_701_750 +")
lines.append("outputs_victim_qwen_751_800")
lines.append("")
...
lines.append("and outputs_victim_qwen_751_800 used the 'reuse' method — "
              "Steps 1-7 images/")
