# ============================================================
# combine_piechart_till_800_qwen25_seq.py
# ============================================================
# Combines results from ALL TWELVE Qwen2.5-VL victim-model batches
# completed so far in the sequential reuse-method series, covering
# the same entries as the first twelve Gemma-victim batches (lines
# 1-800 of qa_data.json):
...
# across all twelve batches — only the victim model is the
...
#
# Saves the chart to:
#   outputs_victim_qwen_751_800/combined_piechart_till_800_qwen25_seq.png
#
...
CHART_PATH = ("outputs_victim_qwen_751_800/"
              "combined_piechart_till_800_qwen25_seq.png")
...
if scored_total == 0:
    ...
    ax.set_title(
        ...
        f"(28+23+26+48+50+50+49+47+30+30+30+30 entries across "
        f"twelve batches, {skipped} skipped)\n"
