# ============================================================
# combine_piechart_till_750_qwen25_seq.py
# ============================================================
# Combines results from ALL ELEVEN Qwen2.5-VL victim-model batches
# completed so far in the sequential reuse-method series, covering
# the same entries as the first eleven Gemma-victim batches (lines
# 1-750 of qa_data.json):
...
# across all eleven batches — only the victim model is the
...
#
# Saves the chart to:
#   outputs_victim_qwen_701_750/combined_piechart_till_750_qwen25_seq.png
#
...
CHART_PATH = ("outputs_victim_qwen_701_750/"
              "combined_piechart_till_750_qwen25_seq.png")
