# ============================================================
# combine_piechart_till_700_qwen25_seq.py
# ============================================================
# Combines results from ALL TEN Qwen2.5-VL victim-model batches
# completed so far in the sequential reuse-method series, covering
# the same entries as the first ten Gemma-victim batches (lines
# 1-700 of qa_data.json):
...
# across all ten batches — only the victim model is the
...
#
# Saves the chart to:
#   outputs_victim_qwen_651_700/combined_piechart_till_700_qwen25_seq.png
#
...
CHART_PATH = ("outputs_victim_qwen_651_700/"
              "combined_piechart_till_700_qwen25_seq.png")
