# ============================================================
# make_combined_victim_qwen_pie_chart.py
# ============================================================
# Combines results from BOTH Qwen2.5-VL victim-model batches:
...
#
# Saves the chart to:
#   outputs_victim_qwen_50/combined_victim_qwen_pie_chart.png
#
...
CHART_PATH = "outputs_victim_qwen_50/combined_victim_qwen_pie_chart.png"
...
if scored_total == 0:
    ...
    ax.set_title(
        ...
        f"(28 + 23 entries across two batches, {skipped} skipped)\n"
