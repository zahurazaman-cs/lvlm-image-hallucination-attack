# ============================================================
# combine_piechart_till_520_qwen25.py
# ============================================================
# Combines results from ALL SEVEN Qwen2.5-VL victim-model batches
# completed so far, covering the same entries as the first seven
# Gemma-victim batches (lines 1-520 of qa_data.json):
...
# across all seven batches — only the victim model is the
# experimental variable)
#
# Produces ONE combined pie chart across all 274 entries showing:
#   - TARGETED hallucination
#   - UNTARGETED hallucination
#   - NONE (no hallucination)
#
# Saves the chart to:
#   outputs_victim_qwen_441_520/combined_piechart_till_520_qwen25.png
#
...
CHART_PATH    = "outputs_victim_qwen_441_520/combined_piechart_till_520_qwen25.png"
...
if scored_total == 0:
    ...
    ax.set_title(
        ...
        f"(28 + 23 + 26 + 48 + 50 + 50 + 49 entries across seven "
