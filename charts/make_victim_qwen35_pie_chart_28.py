# ============================================================
# make_victim_qwen35_pie_chart.py
# ============================================================
# Reads outputs_victim_qwen35_28/entry_state.json (produced by the
# two-phase pipeline_phase1_images.py / pipeline_phase2_victim_
# judge.py pair) and generates a pie chart showing the breakdown of:
#   - TARGETED hallucination
#   - UNTARGETED hallucination
#   - NONE (no hallucination)
#
# Victim model for this run: Qwen3.5 9B (via Ollama)
# Judge model: Gemma-4-abliterated (UNCHANGED from validated pipeline)
# (Image generator name intentionally omitted from the chart title.)
#
# Saves the chart as a PNG inside outputs_victim_qwen35_28/.
#
...
BASE_OUTPUT_DIR = "outputs_victim_qwen35_28"
STATE_PATH      = f"{BASE_OUTPUT_DIR}/entry_state.json"
CHART_PATH      = f"{BASE_OUTPUT_DIR}/victim_qwen35_pie_chart.png"
...
if scored_total == 0:
    ...
    ax.set_title(
        ...
        f"Victim Model: Qwen3.5 9B  |  Judge: Gemma-4-abliterated\n"
