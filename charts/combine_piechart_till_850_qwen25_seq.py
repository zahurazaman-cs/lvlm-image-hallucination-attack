# ============================================================
# combine_piechart_till_850_qwen25_seq.py
# ============================================================
# Combines results from ALL THIRTEEN Qwen2.5-VL victim-model
# batches completed so far in the sequential reuse-method series,
# covering the same entries as the first thirteen Gemma-victim
# batches (lines 1-850 of qa_data.json):
...
# across all thirteen batches — only the victim model is the
...
#
# Saves the chart to:
#   outputs_victim_qwen_801_850/combined_piechart_till_850_qwen25_seq.png
#
...
CHART_PATH = ("outputs_victim_qwen_801_850/"
              "combined_piechart_till_850_qwen25_seq.png")
