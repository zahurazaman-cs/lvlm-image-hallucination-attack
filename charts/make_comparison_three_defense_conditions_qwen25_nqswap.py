# ============================================================
# make_comparison_three_defense_conditions_qwen25_nqswap.py
# ============================================================
# THREE-WAY comparison chart for the NQ-Swap real-world
# generalization test, showing the effect of the two prompt-level
# defenses across the same 100 entries, with Qwen2.5-VL as victim
# throughout and Gemma-4-abliterated as the unchanged judge.
#
#   Condition 1: No Defense (the original attack) — read from
#     outputs_victim_qwen_nqswap_100.
#   Condition 2: Minimal Prompt Defense (short caution/reminder
#     wrap) — read from outputs_qwen25_nqswap_100_wrap.
...
#
# Saves the chart to:
#   outputs_qwen25_nqswap_100_hallucination_analysis/comparison_three_defense_conditions_qwen25_nqswap.png
#
...
CHART_PATH = ("outputs_qwen25_nqswap_100_hallucination_analysis/"
              "comparison_three_defense_conditions_qwen25_nqswap.png")

# ── Condition 1: No Defense — read live ──────────────────────────
COND1_STATE_PATH = "outputs_victim_qwen_nqswap_100/entry_state.json"
...
COND2_STATE_PATH = "outputs_qwen25_nqswap_100_wrap/entry_state.json"
...
COND3_STATE_PATH = "outputs_qwen25_nqswap_100_hallucination_analysis/entry_state.json"
...
fig.suptitle(
    ...
    f"Victim Model: Qwen2.5-VL 7B  |  Judge Model: "
