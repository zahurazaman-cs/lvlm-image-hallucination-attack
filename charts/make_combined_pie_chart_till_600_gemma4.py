...
# ============================================================
# Combines FINAL-ITERATION results from ALL EIGHT strict batch runs:
...
#
# Saves the chart to:
#   outputs_strict_batch_521_600/combined_hallucination_pie_chart.png
#
...
CHART_PATH            = "outputs_strict_batch_521_600/combined_hallucination_pie_chart.png"
...
# ── Load and combine all eight batches ─────────────────────────
...
ax.set_title(
    ...
    f"(28 + 23 + 26 + 48 + 50 + 50 + 49 + 47 entries across eight "
