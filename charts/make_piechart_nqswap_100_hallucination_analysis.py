# ============================================================
# make_piechart_nqswap_100_hallucination_analysis.py
# ============================================================
# Pie chart for the professor-approved Structured
# Hallucination-Analysis Defense condition on the 100-entry
# NQ-Swap real-world generalization dataset, with Gemma-4-
# abliterated as the reprompted victim
...
# block validated on qa_data.json, reviewed and approved by
# Prof. Serra.
#
# Saves the chart to:
#   outputs_nqswap_100_hallucination_analysis/piechart_nqswap_100_hallucination_analysis.png
#
...
STATE_PATH = "outputs_nqswap_100_hallucination_analysis/entry_state.json"
CHART_PATH = ("outputs_nqswap_100_hallucination_analysis/"
              "piechart_nqswap_100_hallucination_analysis.png")
