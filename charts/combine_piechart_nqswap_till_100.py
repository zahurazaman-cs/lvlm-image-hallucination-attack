# ============================================================
# combine_piechart_nqswap_till_100.py
# ============================================================
# Combines results from ALL 100 NQ-Swap real-world generalization
# test entries — the FULL generalization-test target:
...
#     (entries 50-74 — native 3-way scheme)
#   - outputs_strict_batch_nqswap_76_100/SUMMARY.json
#     (entries 75-99 — native 3-way scheme)
#
...
# hallucination-rate finding across a statistically meaningful
# sample (~10% margin of error at n=100).
#
# Saves the chart to:
#   outputs_strict_batch_nqswap_76_100/combined_piechart_nqswap_till_100.png
#
...
CHART_PATH = ("outputs_strict_batch_nqswap_76_100/"
              "combined_piechart_nqswap_till_100.png")
...
statuses_75_99 = [r["status"] for r in batch4]

all_statuses = statuses_0_49 + statuses_50_74 + statuses_75_99
...
print(f"Entries 75-99 (native 3-way) : {len(statuses_75_99)}")
...
if scored_total == 0:
    ...
    ax.set_title(
        ...
        f"HaluEval/HotpotQA, 4 batches (25x4), native 3-way scheme\n"
