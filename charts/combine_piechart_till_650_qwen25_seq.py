# ============================================================
# combine_piechart_till_650_qwen25_seq.py
# ============================================================
# Combines results from ALL NINE Qwen2.5-VL victim-model batches
# completed so far in the sequential reuse-method series, covering
# the same entries as the first nine Gemma-victim batches (lines
# 1-650 of qa_data.json):
...
#     this is a DIFFERENT, distinct folder from the earlier abandoned
#     two-phase attempt at this same batch, which used a different
#     entry_state.json structure and is not included here)
#
# Victim model (target model, Step 8): Qwen2.5-VL 7B (via Ollama)
# Judge model (Step 9 classifier): Gemma-4-abliterated (UNCHANGED
# across all nine batches — only the victim model is the
...
#
# Saves the chart to:
#   outputs_victim_qwen_601_650_reuse/combined_piechart_till_650_qwen25_seq.png
#
...
CHART_PATH = ("outputs_victim_qwen_601_650_reuse/"
              "combined_piechart_till_650_qwen25_seq.png")
