# ============================================================
# make_defense_piechart_textonly.py
# ============================================================
# Pie chart for the TEXT-ONLY WARNING defense condition
# (outputs_defense_gemma4_textonly) — Step 8's prompt told the
# victim model that the article's TEXT is authoritative and to
# disregard the image when the two conflict.
#
...
#
# Saves the chart to:
#   outputs_defense_gemma4_textonly/defense_piechart_textonly.png
#
...
STATE_PATH = "outputs_defense_gemma4_textonly/entry_state.json"
CHART_PATH = "outputs_defense_gemma4_textonly/defense_piechart_textonly.png"
...
ax.set_title(
    ...
    f"Warning Style: Text-Focused (article text treated as "
    f"authoritative over the image)\n"
