...
from batch_config__qwen25_till_650 import (
...
for idx in BATCH_INDICES:
    ...
    if s.get("awaiting_judgment_iter") == CURRENT_ITER:
        continue  # already generated for this iteration — just waiting on
                  # Phase 2 (e.g. a prior run crashed mid-Phase-2). Do NOT
                  # regenerate; the image is still valid and ready.
