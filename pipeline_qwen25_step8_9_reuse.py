...
# one go.
#
# Pre-configured for the THIRD Gemma batch: outputs_strict_batch_
# 151_200 (26 entries). To reuse for a different batch, just change
...
# ─── CONFIG ──────────────────────────────────────────────────
SOURCE_BATCH_DIR = "outputs_strict_batch_151_200"   # EDIT PER BATCH
OUTPUT_DIR        = "outputs_victim_qwen_151_200"    # EDIT PER BATCH
