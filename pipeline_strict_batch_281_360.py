# ============================================================
# pipeline_strict_batch_281_360.py — Strict Pipeline, Lines 281-360
# ============================================================
# Scans lines 281-360 of qa_data.json for human-celebrity entries —
...
# abstract facts. 58 entries qualified; trimmed down to the
# strongest 50 (dropping the 8 most obscure/hardest-to-photograph)
# to keep SerpApi usage safely within the remaining monthly quota.
#
...
#
# Output directory: outputs_strict_batch_281_360
# ============================================================
...
# 0-indexed line numbers in qa_data.json for 50 human-celebrity
# entries identified within lines 281-360 (trimmed down from the
# 58 originally found, dropping the 8 most obscure/hardest-to-
# photograph entries to keep SerpApi usage within quota: Julie
# Cooper, Trevor Prangley, Prince Hall, Betzy Kjelsberg, Byron
# Edmund Walker, Andrés D'Alessandro, Keith Park/Arthur Noss, and
# Dirkie Chamberlain).
#
#   line#(1-idx) -> subject
#   281 -> John Schneider / Tom Wopat / James Best (actors)
#   282 -> Joe Manganiello / Kirk Kerkorian
#   283 -> Lee Il-hyung (director)
#   284 -> Rick Seibold / Katelyn Tarver
#   286 -> Adam Beach / David Ayer
#   287 -> Alamgir / Ali Azmat (musicians)
#   288 -> Barry Bonds
#   289 -> Scott Derrickson (director)
#   292 -> George Palmer Putnam / Amelia Earhart
#   293 -> Emma Rose Kenney (actress)
#   294 -> Hosni Mubarak
#   296 -> Akhilendra Mishra (actor)
#   298 -> Javier Mora / Alexander Povetkin (boxers)
#   299 -> George Frideric Handel / Antonio Vivaldi (composers)
#   300 -> Ekaterina Gordeeva / Tatiana Tarasova (figure skaters)
#   301 -> Hillary Rodham Clinton
#   302 -> Mike Leach (football coach)
#   304 -> Arthur Darvill / Matt Smith (actors)
#   305 -> John Layfield / Ron Simmons (wrestlers)
#   307 -> Reggie Yates (TV presenter)
#   308 -> John Ruskin / Fanny Talbot
#   309 -> Dennis Greene / Richard Berry (musicians)
#   310 -> Prodigy / Albert Johnson (rapper)
#   313 -> Chelsea Handler
#   314 -> Herbie Flowers / Paul McCartney
#   315 -> Frederick the Great
#   316 -> Subrahmanyan Chandrasekhar / C. V. Raman
#   318 -> Owen Wilson / Jackie Chan
#   320 -> Simone Kirby (actress)
#   321 -> Rafael Nadal
#   322 -> June Jones (football coach)
#   326 -> Scott Joplin (composer)
#   327 -> Priyanka Chopra / Ram Charan (actors)
#   328 -> Jagmeet Singh (politician)
#   332 -> Billy Vessels (Heisman winner)
#   336 -> Arthur Nascarella (actor)
#   337 -> Josh Jackson (NBA player)
#   340 -> Roy Moore (judge/political figure)
#   343 -> Peter Hansen / Kathleen Turner (actors)
#   346 -> Elvis Presley
#   347 -> Ian MacKaye (musician)
#   348 -> George Gershwin (composer)
#   349 -> Richard Yates / Italo Calvino (authors)
#   350 -> Ricky Gervais (comedian)
#   351 -> Patrick White / Katherine Anne Porter (authors)
#   352 -> John Carney (director)
#   353 -> Bob Hope
#   354 -> Johnny Depp (referenced via 21 Jump Street)
#   355 -> Kim Roberts (actress)
#   357 -> Marpessa Hennink / Domenico Dolce / Stefano Gabbana
BATCH_INDICES = [
    280, 281, 282, 283, 285, 286, 287, 288, 291, 292, 293, 295,
    297, 298, 299, 300, 301, 303, 304, 306, 307, 308, 309, 312,
    313, 314, 315, 317, 319, 320, 321, 325, 326, 327, 331, 335,
    336, 339, 342, 345, 346, 347, 348, 349, 350, 351, 352, 353,
    354, 356
]

BASE_OUTPUT_DIR = "outputs_strict_batch_281_360"
...
print(f"\n{'='*65}")
print(f"PIPELINE_STRICT_BATCH_281_360 COMPLETE — {total_time:.1f}s this run")
print(f"{'='*65}")
for r in results:
    print(
...
report_lines = [
    "="*65,
    "PIPELINE_STRICT_BATCH_281_360 — FINAL REPORT",
    "="*65,
