# ============================================================
# pipeline_strict_batch_601_650.py — Strict Pipeline, Lines 601-650
# ============================================================
# Scans lines 601-650 of qa_data.json for human-celebrity entries —
...
# abstract facts. 37 qualifying entries were found; trimmed to the
...
#
# Output directory: outputs_strict_batch_601_650
# ============================================================
...
# entries identified within lines 601-650 (trimmed down from 37
# originally found, dropping the 7 most obscure/moderate ones to
# match the requested batch size of 30).
#
#   line#(1-idx) -> subject
#   601 -> Ike Turner / Tina Turner (musicians)
#   602 -> Mary Doria Russell / James Joyce (authors)
#   603 -> James Clark McReynolds / Calvin Coolidge (historical figures)
#   604 -> Oleg Menshikov (actor)
#   605 -> Olympia Dukakis / Norman Jewison (actress/director)
#   606 -> Skyler Elizabeth Day (actress)
#   607 -> Marvin Humes (DJ/host)
#   609 -> Jefferson C. Davis (historical general)
#   610 -> Molière (historical playwright)
#   611 -> Percy Grainger (historical composer)
#   615 -> George Jones (country singer)
#   616 -> Kenji Mizoguchi / Andrzej Żuławski (directors)
#   617 -> Smriti Irani (politician/actress)
#   618 -> Jessica Alba (actress)
#   619 -> Inga Bejer Engh (prosecutor)
#   621 -> Robert Boyle (historical scientist)
#   623 -> Jason Statham / Guy Ritchie
#   625 -> Robin Weaver (actress)
#   626 -> Ben Affleck / Whitney Williams
#   627 -> Edward Burne-Jones (historical artist)
#   628 -> Nikolaas Tinbergen / Konrad Lorenz (Nobel laureates)
#   629 -> Bob Stoops (football coach)
#   631 -> Conway Twitty / Loretta Lynn (country legends)
#   633 -> Dr. Seuss (author)
#   634 -> Nikos Koundouros / Curtis Hanson (directors)
#   636 -> Gary Sinise (actor)
#   637 -> Renée Montagne / Bob Edwards (broadcasters)
#   638 -> Scott Lowell (actor)
#   642 -> Dave Grohl (musician)
#   645 -> Audre Lorde / John le Carré (authors)
BATCH_INDICES = [
...
BASE_OUTPUT_DIR = "outputs_strict_batch_601_650"
...
print(f"\n{'='*65}")
print(f"PIPELINE_STRICT_BATCH_601_650 COMPLETE — {total_time:.1f}s this run")
print(f"{'='*65}")
for r in results:
    print(
...
report_lines = [
    "="*65,
    "PIPELINE_STRICT_BATCH_601_650 — FINAL REPORT",
    "="*65,
