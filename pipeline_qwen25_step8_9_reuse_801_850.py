...
# one go.
#
# Pre-configured for the THIRTEENTH Gemma batch: outputs_strict_
# batch_801_850 (30 entries). To reuse for a different batch, just
# change SOURCE_BATCH_DIR and OUTPUT_DIR below.
# ============================================================
...
# ─── CONFIG ──────────────────────────────────────────────────
SOURCE_BATCH_DIR = "outputs_strict_batch_801_850"   # EDIT PER BATCH
OUTPUT_DIR        = "outputs_victim_qwen_801_850"    # EDIT PER BATCH
