...
# one go.
#
# Pre-configured for the SIXTH Gemma batch: outputs_strict_batch_
# 361_440_combined (50 entries). To reuse for a different batch,
# just change SOURCE_BATCH_DIR and OUTPUT_DIR below.
# ============================================================
...
# ─── CONFIG ──────────────────────────────────────────────────
SOURCE_BATCH_DIR = "outputs_strict_batch_361_440_combined"   # EDIT PER BATCH
OUTPUT_DIR        = "outputs_victim_qwen_361_440"             # EDIT PER BATCH
