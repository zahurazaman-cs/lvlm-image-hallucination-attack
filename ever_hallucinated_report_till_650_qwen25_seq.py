# ============================================================
# ever_hallucinated_report_till_650_qwen25_seq.py
# ============================================================
# Combines all NINE Qwen2.5-VL victim-model batches:
...
#     abandoned two-phase attempt at this same batch range, which
#     used a different entry_state.json structure and is NOT
...
# Gemma-victim reports. For the seven reuse-method batches, there is
...
#
# Writes: Ever_hallucinated_report_till_650_qwen25_seq.txt
# ============================================================
...
REPORT_PATH = "Ever_hallucinated_report_till_650_qwen25_seq.txt"
...
lines.append("outputs_victim_qwen_361_440 + outputs_victim_qwen_441_520 + "
              "outputs_victim_qwen_521_600 +")
lines.append("outputs_victim_qwen_601_650_reuse")
lines.append("")
...
lines.append("victim_qwen_521_600, and outputs_victim_qwen_601_650_reuse")
