# ============================================================
# pipeline_reclassify_all500_hallucination_analysis.py
# ============================================================
...
#            HALLUCINATION_ANALYSIS prompt validated in the 332
#            entry defense experiment. ONE pass per entry (no
#            escalation loop — the image is already fixed at its
#            final state from the original run).
...
OUTPUT_DIR = "outputs_step8_reclassify_all500_hallucination_analysis"
...
# HALLUCINATION_ANALYSIS tagged section. This replaces the earlier
# short CAUTION/REMINDER pair. Since this test is a single pass per
# entry, there is no history of prior wrong answers to include.
...
print(f"\n{'='*65}")
print(f"RECLASSIFY ALL 500 — HALLUCINATION_ANALYSIS prompt (Step 8), Step 9 unchanged")
...
print(f"\n{'='*65}")
print("RECLASSIFY ALL 500 — FINAL SUMMARY (HALLUCINATION_ANALYSIS Step 8 prompt)")
print(f"{'='*65}")
