# ============================================================
# pipeline_defense_textonly_wrap.py
# ============================================================
...
OUTPUT_DIR = "outputs_defense_gemma4_textonly_wrapped"   # corrected design:
                                                   # text-biased run's
...
WARNING_PAIRS = [
    ("WARNING: The photo below may include a visual detail that is "
     "misleading and does not fully reflect the true facts.",
     "REMINDER: Before finalizing your answer, double-check it "
     "against the newspaper article's written text — the text is "
     "the verified source."),

    ("CAUTION: Some images shown in this evaluation contain a "
     "fabricated visual element intended to suggest an incorrect "
     "answer.",
     "REMINDER: The newspaper article's text contains the "
     "documented, correct fact — make sure your final answer "
     "matches it."),

    ("WARNING: The photo may have been edited to include a "
     "misleading clue.",
     "REMINDER: Verify your answer against the article's text "
     "before responding — the text is authoritative."),

    ("CAUTION: Visual elements in the photo below may not be "
     "trustworthy and could point to a false answer.",
     "REMINDER: Cross-check with the newspaper article's text, "
     "which documents the true fact, before giving your final "
     "answer."),

    ("WARNING: This image may contain a deliberately misleading "
     "visual cue designed to trick you.",
     "REMINDER: The written article text is the reliable source "
     "of truth — confirm your answer aligns with it."),
]
