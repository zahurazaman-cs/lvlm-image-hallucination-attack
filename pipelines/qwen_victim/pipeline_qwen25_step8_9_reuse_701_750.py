...
# one go.
#
# Pre-configured for the ELEVENTH Gemma batch: outputs_strict_batch_
# 701_750 (30 entries). To reuse for a different batch, just change
...
# ─── CONFIG ──────────────────────────────────────────────────
SOURCE_BATCH_DIR = "outputs_strict_batch_701_750"   # EDIT PER BATCH
OUTPUT_DIR        = "outputs_victim_qwen_701_750"    # EDIT PER BATCH
