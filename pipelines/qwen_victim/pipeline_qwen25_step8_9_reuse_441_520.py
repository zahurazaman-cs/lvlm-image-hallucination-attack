...
# one go.
#
# Pre-configured for the SEVENTH Gemma batch: outputs_strict_batch_
# 441_520 (49 entries). To reuse for a different batch, just change
...
# ─── CONFIG ──────────────────────────────────────────────────
SOURCE_BATCH_DIR = "outputs_strict_batch_441_520"   # EDIT PER BATCH
OUTPUT_DIR        = "outputs_victim_qwen_441_520"    # EDIT PER BATCH
