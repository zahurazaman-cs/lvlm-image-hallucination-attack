...
# one go.
#
# Pre-configured for the NINTH Gemma batch: outputs_strict_batch_
# 601_650 (30 entries). To reuse for a different batch, just change
# SOURCE_BATCH_DIR and OUTPUT_DIR below.
#
# NOTE: this batch was previously attempted via the crash-prone
# two-phase pipeline (output folder outputs_victim_qwen_601_650,
# which uses a DIFFERENT entry_state.json structure). This run uses
# a distinct output folder (outputs_victim_qwen_601_650_reuse) so it
# never collides with or gets confused with that earlier attempt.
# ============================================================
...
# ─── CONFIG ──────────────────────────────────────────────────
SOURCE_BATCH_DIR = "outputs_strict_batch_601_650"          # EDIT PER BATCH
OUTPUT_DIR        = "outputs_victim_qwen_601_650_reuse"    # EDIT PER BATCH
