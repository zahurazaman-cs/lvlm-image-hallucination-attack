...
# one go.
#
# Pre-configured for the FIFTH Gemma batch: outputs_strict_batch_
# 281_360 (50 entries). To reuse for a different batch, just change
...
# ─── CONFIG ──────────────────────────────────────────────────
SOURCE_BATCH_DIR = "outputs_strict_batch_281_360"   # EDIT PER BATCH
OUTPUT_DIR        = "outputs_victim_qwen_281_360"    # EDIT PER BATCH
