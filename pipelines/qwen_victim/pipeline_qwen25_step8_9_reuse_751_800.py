...
# one go.
#
# Pre-configured for the TWELFTH Gemma batch: outputs_strict_batch_
# 751_800 (30 entries). To reuse for a different batch, just change
...
# ─── CONFIG ──────────────────────────────────────────────────
SOURCE_BATCH_DIR = "outputs_strict_batch_751_800"   # EDIT PER BATCH
OUTPUT_DIR        = "outputs_victim_qwen_751_800"    # EDIT PER BATCH
