...
# one go.
#
# Pre-configured for the EIGHTH Gemma batch: outputs_strict_batch_
# 521_600 (47 entries). To reuse for a different batch, just change
...
# ─── CONFIG ──────────────────────────────────────────────────
SOURCE_BATCH_DIR = "outputs_strict_batch_521_600"   # EDIT PER BATCH
OUTPUT_DIR        = "outputs_victim_qwen_521_600"    # EDIT PER BATCH
