...
BATCH_INDICES = list(range(25))

BASE_OUTPUT_DIR = "outputs_strict_batch_nqswap_25"
...
print(f"\n{'='*65}")
print(f"PIPELINE_STRICT_BATCH_NQSWAP_25 COMPLETE — {total_time:.1f}s this run")
print(f"{'='*65}")
for r in results:
    print(
...
report_lines = [
    "="*65,
    "PIPELINE_STRICT_BATCH_NQSWAP_25 — FINAL REPORT",
    "="*65,
