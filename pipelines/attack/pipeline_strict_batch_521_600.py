# ============================================================
# pipeline_strict_batch_521_600.py — Strict Pipeline, Lines 521-600
# ============================================================
# Scans lines 521-600 of qa_data.json for human-celebrity entries —
...
# abstract facts. 47 qualifying entries were found.
#
...
#
# Output directory: outputs_strict_batch_521_600
# ============================================================
...
# 0-indexed line numbers in qa_data.json for the 47 human-celebrity
# entries identified within lines 521-600.
#
#   line#(1-idx) -> subject
#   521 -> Nick Murphy (director)
#   522 -> Kelly Jones / Martha Reeves (musicians)
#   523 -> Ivan "John" Jurkovic (NFL player)
#   524 -> Dick Van Dyke / Jerry Van Dyke / Shane Van Dyke
#   525 -> Choi Min-sik / Luc Besson
#   526 -> Brothers Grimm (historical authors)
#   528 -> Count Francesco Baracca (WWI fighter ace)
#   530 -> Alan Merrill (musician)
#   532 -> Andrew Goth / Antonia Campbell-Hughes (director/actress)
#   533 -> Jordan Mintz (Enron whistleblower)
#   534 -> Roni Stoneman / Gordie Tapp (entertainers)
#   537 -> Vladislav Lantratov (ballet dancer)
#   538 -> Phillip Calvert (historical governor)
#   540 -> Ali Zafar (actor/singer)
#   543 -> Jeremy Brock / Rosemary Sutcliff (writer/author)
#   544 -> Gabe Turner / Kevin Spacey
#   545 -> Seamus Heaney (Nobel poet)
#   546 -> Stephen Wolfram (scientist)
#   547 -> 50 Cent (musician)
#   548 -> Mark Rankin / Cedric Bixler-Zavala (musicians)
#   549 -> Ben Kingsley (actor)
#   551 -> Summit1g (streamer)
#   554 -> Greta Garbo (actress)
#   555 -> Bob Welch (musician)
#   556 -> Dennis Doherty / John Phillips (musicians)
#   558 -> Arto Tunçboyacıyan (musician)
#   560 -> Matt Reeves (director)
#   561 -> Béla Bartók (composer)
#   563 -> Tony Rice / Rebecca Rippy (musicians)
#   567 -> Belinda Carlisle (musician)
#   568 -> Logan Lerman (actor)
#   570 -> Philippe Coutinho / Cristiano Ronaldo (footballers)
#   572 -> John Forsythe (actor)
#   573 -> Seth Rogen / Judd Apatow
#   575 -> Curly Ray Cline (musician)
#   576 -> Fritz von Brodowski (historical general)
#   577 -> Wizzo / YG (musicians)
#   583 -> Elia Kazan (director)
#   584 -> Sameera Perera (cricketer)
#   585 -> Oskar Schindler / Abraham Bankier
#   587 -> Ryan Zinke / Kevin Haugrud (politicians)
#   588 -> Boban Rajović (singer)
#   589 -> Roger Staubach / Troy Aikman (NFL legends)
#   591 -> Cyril Briggs (historical activist)
#   592 -> Bob Edwards / Renee Montagne (broadcasters)
#   596 -> Katherine Parkinson (actress)
#   597 -> Fergie (singer)
BATCH_INDICES = [
    520, 521, 522, 523, 524, 525, 527, 529, 531, 532, 533, 536,
    537, 539, 542, 543, 544, 545, 546, 547, 548, 550, 553, 554,
    555, 557, 559, 560, 562, 566, 567, 569, 571, 572, 574, 575,
    576, 582, 583, 584, 586, 587, 588, 590, 591, 595, 596
]

BASE_OUTPUT_DIR = "outputs_strict_batch_521_600"
...
print(f"\n{'='*65}")
print(f"PIPELINE_STRICT_BATCH_521_600 COMPLETE — {total_time:.1f}s this run")
print(f"{'='*65}")
for r in results:
    print(
...
report_lines = [
    "="*65,
    "PIPELINE_STRICT_BATCH_521_600 — FINAL REPORT",
    "="*65,
