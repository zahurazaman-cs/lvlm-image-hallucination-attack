# ============================================================
# pipeline_strict_batch_701_750.py — Strict Pipeline, Lines 701-750
# ============================================================
# Scans lines 701-750 of qa_data.json for human-celebrity entries —
...
#
# Output directory: outputs_strict_batch_701_750
# ============================================================
...
# entries identified within lines 701-750 (trimmed down from 35
# originally found, dropping the 5 most obscure/moderate ones to
# match the requested batch size of 30).
#
#   line#(1-idx) -> subject
#   701 -> Terence Davies / Richard Wallace (directors)
#   702 -> Stephen Herek / Charlie Sheen (director/actor)
#   704 -> Jamaal Charles (NFL player)
#   705 -> 21 Savage / Drake (rappers)
#   706 -> Raymond Mays (historical racing driver)
#   707 -> Rashida Jones / Charlie Brooker
#   712 -> Reiner Knizia (board game designer)
#   714 -> Christopher Paolini (author)
#   715 -> Alex Lowe (mountaineer)
#   716 -> David Cutcliffe (football coach)
#   718 -> Arijit Singh / Amitabh Bhattacharya (musicians)
#   720 -> Don Everly / The Everly Brothers
#   721 -> Peter Cetera / Jeremy McKinnon (musicians)
#   722 -> Dario Cologna (Olympic skier)
#   724 -> Jason Statham / Ruby Rose
#   725 -> Jack Johnson (musician)
#   730 -> Kota Shivaram Karanth (historical writer)
#   731 -> Tony Blair
#   733 -> Larry Linville (actor)
#   736 -> Sue Perkins (comedian)
#   738 -> Egon Schiele (historical painter)
#   740 -> James Lovell (astronaut)
#   742 -> Abraham Roqueñi Iglesias / Andy Souwer (kickboxers)
#   744 -> Dennis Ritchie (computer scientist)
#   745 -> Denis Johnson (author)
#   746 -> Hillary Clinton / Ann O'Leary
#   747 -> Tony Scott (director)
#   748 -> James MacGregor / George V (historical figures)
#   749 -> Damontre Lamounte Moore (NFL player)
BATCH_INDICES = [
    700, 701, 703, 704, 705, 706, 711, 713, 714, 715, 717, 719,
    720, 721, 722, 724, 725, 730, 731, 733, 736, 738, 740, 742,
    744, 745, 746, 747, 748, 749
]

BASE_OUTPUT_DIR = "outputs_strict_batch_701_750"
...
print(f"\n{'='*65}")
print(f"PIPELINE_STRICT_BATCH_701_750 COMPLETE — {total_time:.1f}s this run")
print(f"{'='*65}")
for r in results:
    print(
...
report_lines = [
    "="*65,
    "PIPELINE_STRICT_BATCH_701_750 — FINAL REPORT",
    "="*65,
