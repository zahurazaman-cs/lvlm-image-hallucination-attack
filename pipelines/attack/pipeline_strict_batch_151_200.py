# ============================================================
# pipeline_strict_batch_151_200.py — Strict Pipeline, Lines 151-200
# ============================================================
# Scans lines 151-200 of qa_data.json (the next 50 after 1-100 and
# 101-150 already covered) for human-celebrity entries — same
# criteria as before: a real, identifiable, non-fictional person
# (or a simple two-person real comparison), excluding bands/groups
# of 3+, fictional characters, companies, places, and abstract
# facts. 26 qualifying entries were found (see BATCH_INDICES below).
#
...
#
# Output directory: outputs_strict_batch_151_200
# ============================================================
...
# 0-indexed line numbers in qa_data.json for the 26 human-celebrity
# entries identified within lines 151-200.
#
#   line#(1-idx) -> subject
#   151 -> Abe Weinberg / Vincent "Mad Dog" Coll (historical gangsters)
#   153 -> John Starks / Danny Manning (NBA players)
#   156 -> Isabelle Mergault / François Cluzet (French actress/director)
#   158 -> Carl Orff (composer)
#   159 -> Mackenzie Davis / Michael Dowse (actress/director)
#   160 -> Barack Obama
#   162 -> Sarah J. Maas (author)
#   164 -> Axle Whitehead (actor)
#   165 -> Joseph Roth / Cid Corman (authors)
#   167 -> Lucy Gordon / Peter Chelsom (actress/director)
#   169 -> Edgar Valdez Villarreal "La Barbie" (drug lord)
#   170 -> Roy Jenkins (politician)
#   171 -> Odysseas Elytis / Cornel West (poet/philosopher)
#   176 -> Richard Ford / Robert E. Howard (authors)
#   179 -> IU / Lee Ji-eun (singer/actress)
#   180 -> Dan Aykroyd (actor)
#   181 -> Lincoln J. Beachey (aviator)
#   183 -> Augusto Pinochet (dictator)
#   184 -> Huma Abedin / Saleha Mahmood Abedin (political figures)
#   186 -> Lzzy Hale (singer)
#   187 -> Ted Sutton / Mel Gibson (actors)
#   188 -> Chris Evert / Mara Santangelo (tennis players)
#   189 -> Sarah Manninen / Martha Coolidge (actress/director)
#   192 -> Arthur Rudolph / Wernher von Braun (rocket scientists)
#   194 -> Neha Sharma (actress)
#   200 -> Millard Fillmore (US President)
BATCH_INDICES = [
    150, 152, 155, 157, 158, 159, 161, 163, 164, 166, 168, 169,
    170, 175, 178, 179, 180, 182, 183, 185, 186, 187, 188, 191,
    193, 199
]

BASE_OUTPUT_DIR = "outputs_strict_batch_151_200"
...
print(f"\n{'='*65}")
print(f"PIPELINE_STRICT_BATCH_151_200 COMPLETE — {total_time:.1f}s this run")
print(f"{'='*65}")
for r in results:
    print(
...
report_lines = [
    "="*65,
    "PIPELINE_STRICT_BATCH_151_200 — FINAL REPORT",
    "="*65,
