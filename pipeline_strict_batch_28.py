# ============================================================
# pipeline_strict_batch_28.py — Stricter Pipeline, Full 28 Entries
# ============================================================
# Same 10-step design and Step 5 name-free constraint validated in
# pipeline_strict_batch.py (2-entry test on Peggy Seeger / Jonathan
# Stark), now run across all 28 human-celebrity entries identified
# earlier within the first 100 lines of qa_data.json.
#
...
# entries identified within the first 100 lines (same list used in
# pipeline_final_batch.py).
BATCH_INDICES = [
...
print(f"\n{'='*65}")
print(f"PIPELINE_STRICT_BATCH_28 COMPLETE — {total_time:.1f}s this run")
print(f"{'='*65}")
for r in results:
    print(
...
report_lines = [
    "="*65,
    "PIPELINE_STRICT_BATCH_28 — FINAL REPORT",
    "="*65,
