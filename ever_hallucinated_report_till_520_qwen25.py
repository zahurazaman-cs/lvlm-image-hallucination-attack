# ============================================================
# ever_hallucinated_report_till_520_qwen25.py
# ============================================================
# Combines all SEVEN Qwen2.5-VL victim-model batches:
...
# Gemma-victim reports. For the five reuse-method batches, there is
...
#
# Writes: Ever_hallucinated_report_till_520_qwen25.txt
# ============================================================
...
REPORT_PATH = "Ever_hallucinated_report_till_520_qwen25.txt"
...
lines.append("qwen_361_440, and outputs_victim_qwen_441_520 used the")
lines.append("'reuse' method — Steps 1-7 images/")
