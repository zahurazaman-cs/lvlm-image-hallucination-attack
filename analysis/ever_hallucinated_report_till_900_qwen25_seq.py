# ============================================================
# ever_hallucinated_report_till_900_qwen25_seq.py
# ============================================================
# Combines all FOURTEEN Qwen2.5-VL victim-model batches — the
# FULL, complete sequential reuse-method series:
...
#   - outputs_victim_qwen_751_800         (30 entries, reuse method)
#   - outputs_victim_qwen_801_850         (30 entries, reuse method)
#   - outputs_victim_qwen_851_900         (30 entries, reuse method)
#
...
# Gemma-victim reports. For the twelve reuse-method batches, there
# is only one iteration per entry by design (the final Gemma-
# escalated image was reused directly rather than re-escalated), so
# "final" and "ever" are identical for those entries — this is
# noted explicitly rather than treated as a coincidence.
#
# This is the FULL, complete counterpart to the Gemma-victim
# 500-entry ever-hallucinated report.
#
# Writes: Ever_hallucinated_report_till_900_qwen25_seq.txt
# ============================================================
...
REPORT_PATH = "Ever_hallucinated_report_till_900_qwen25_seq.txt"
...
lines.append("outputs_victim_qwen_601_650_reuse + outputs_victim_qwen_651_700 + "
              "outputs_victim_qwen_701_750 +")
lines.append("outputs_victim_qwen_751_800 + outputs_victim_qwen_801_850 + "
              "outputs_victim_qwen_851_900")
lines.append("")
...
lines.append("outputs_victim_qwen_651_700, outputs_victim_qwen_701_750,")
lines.append("outputs_victim_qwen_751_800, outputs_victim_qwen_801_850,")
lines.append("and outputs_victim_qwen_851_900 used the 'reuse' method — "
              "Steps 1-7 images/")
