# ============================================================
# ever_hallucinated_report_till_600_qwen25.py
# ============================================================
# Combines all EIGHT Qwen2.5-VL victim-model batches:
...
# Gemma-victim reports. For the six reuse-method batches, there is
...
#
# Writes: Ever_hallucinated_report_till_600_qwen25.txt
# ============================================================
...
REPORT_PATH = "Ever_hallucinated_report_till_600_qwen25.txt"
...
lines.append("qwen_361_440, outputs_victim_qwen_441_520, and outputs_")
lines.append("victim_qwen_521_600 used the 'reuse' method — Steps 1-7 images/")
