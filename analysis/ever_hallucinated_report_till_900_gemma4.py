# ============================================================
# ever_hallucinated_report_till_900_gemma4.py
# ============================================================
# Scans EVERY iteration's Step 9 classification file (not just the
# final one) across all FOURTEEN strict batches (Gemma-4-abliterated as
# victim + judge, Qwen-Image-Edit-2509 as image generator), covering
# lines 1-900 of qa_data.json, and reports TWO statistics side by
# side:
#
...
#
# Reads iteration files from all fourteen batch directories:
#   outputs_strict_batch_28, _50, _151_200, _201_280, _281_360,
#   _361_440_combined, _441_520, _521_600, _601_650, _651_700,
#   _701_750, _751_800, _801_850, _851_900
#
# Writes:
#   EVER_HALLUCINATED_REPORT_till_900_gemma4.txt (in the current
#   directory)
# ============================================================
...
BATCHES = [
    ...
    },
    {
        ...
        "iter_pattern": "step9_hallucination_iter*.txt",
        "summary_path": "outputs_strict_batch_441_520/SUMMARY.json",
        "final_category_key": "status",
    },
    {
        "name": "outputs_strict_batch_521_600",
        "iter_pattern": "step9_hallucination_iter*.txt",
        "summary_path": "outputs_strict_batch_521_600/SUMMARY.json",
        "final_category_key": "status",
    },
    {
        "name": "outputs_strict_batch_601_650",
        "iter_pattern": "step9_hallucination_iter*.txt",
        "summary_path": "outputs_strict_batch_601_650/SUMMARY.json",
        "final_category_key": "status",
    },
    {
        "name": "outputs_strict_batch_651_700",
        "iter_pattern": "step9_hallucination_iter*.txt",
        "summary_path": "outputs_strict_batch_651_700/SUMMARY.json",
        "final_category_key": "status",
    },
    {
        "name": "outputs_strict_batch_701_750",
        "iter_pattern": "step9_hallucination_iter*.txt",
        "summary_path": "outputs_strict_batch_701_750/SUMMARY.json",
        "final_category_key": "status",
    },
    {
        "name": "outputs_strict_batch_751_800",
        "iter_pattern": "step9_hallucination_iter*.txt",
        "summary_path": "outputs_strict_batch_751_800/SUMMARY.json",
        "final_category_key": "status",
    },
    {
        "name": "outputs_strict_batch_801_850",
        "iter_pattern": "step9_hallucination_iter*.txt",
        "summary_path": "outputs_strict_batch_801_850/SUMMARY.json",
        "final_category_key": "status",
    },
    {
        "name": "outputs_strict_batch_851_900",
        "iter_pattern": "step9_hallucination_iter*.txt",
        "summary_path": "outputs_strict_batch_851_900/SUMMARY.json",
        "final_category_key": "status",
    },
]
...
def scan_batch(batch):
    ...
    """
    entry_dirs = sorted(
        glob.glob(f"{batch['name']}/entry_[0-9]*"),
...
with open("EVER_HALLUCINATED_REPORT_till_900_gemma4.txt", "w") as f:
    f.write(report_text)

print("\nSaved report to: EVER_HALLUCINATED_REPORT_till_900_gemma4.txt")
