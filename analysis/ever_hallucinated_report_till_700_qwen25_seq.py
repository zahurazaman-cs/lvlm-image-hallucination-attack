# ============================================================
# ever_hallucinated_report_till_700_qwen25_seq.py
# ============================================================
# Combines all TEN Qwen2.5-VL victim-model batches:
...
# Gemma-victim reports. For the eight reuse-method batches, there is
...
#
# Writes: Ever_hallucinated_report_till_700_qwen25_seq.txt
# ============================================================
...
REPORT_PATH = "Ever_hallucinated_report_till_700_qwen25_seq.txt"
...
lines.append("and outputs_victim_qwen_651_700 used the 'reuse' method — "
              "Steps 1-7 images/")
