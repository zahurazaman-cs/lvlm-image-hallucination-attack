# ============================================================
# ever_hallucinated_report_combined_victim_qwen.py
# ============================================================
# Scans EVERY iteration's Step 9 classification file (not just the
# final one) across BOTH Qwen2.5-VL victim-model batches:
#   - outputs_victim_qwen_28  (28 entries)
#   - outputs_victim_qwen_50  (23 entries)
#
# Reports TWO statistics side by side:
#   1. FINAL-ITERATION statistic (what entry_state.json reports)
#   2. "EVER HALLUCINATED" statistic — did this entry hallucinate
#      (targeted OR untargeted) on ANY iteration, even if a later
#      iteration landed on the correct answer?
#
# Writes: outputs_victim_qwen_50/EVER_HALLUCINATED_REPORT_combined_qwen.txt
# ============================================================
...
REPORT_PATH = "outputs_victim_qwen_50/EVER_HALLUCINATED_REPORT_combined_qwen.txt"
...
lines.append("Combined across outputs_victim_qwen_28 + outputs_victim_qwen_50")
lines.append("=" * 65)
