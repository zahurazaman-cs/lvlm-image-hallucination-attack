# ============================================================
# make_combined_piechart_till_850_gemma4.py
# ============================================================
# Combines FINAL-ITERATION results from ALL THIRTEEN strict batch
# runs (Gemma-4-abliterated as victim + judge, Qwen-Image-Edit-2509
# as image generator) covering lines 1-850 of qa_data.json:
...
#      field: "status")
#
# Produces ONE combined pie chart across all 471 entries showing:
...
#
# Saves the chart to:
#   outputs_strict_batch_801_850/combined_hallucination_pie_chart.png
#
...
CHART_PATH            = "outputs_strict_batch_801_850/combined_hallucination_pie_chart.png"
...
# ── Load and combine all thirteen batches ──────────────────────
...
ax.set_title(
    ...
    f"(28+23+26+48+50+50+49+47+30+30+30+30+30 entries across "
    f"thirteen batches, {skipped} skipped)\n"
