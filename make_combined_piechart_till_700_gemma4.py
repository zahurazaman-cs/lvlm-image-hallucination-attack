# ============================================================
# make_combined_piechart_till_700_gemma4.py
# ============================================================
# Combines FINAL-ITERATION results from ALL TEN strict batch runs
# (Gemma-4-abliterated as victim + judge, Qwen-Image-Edit-2509 as
# image generator) covering lines 1-700 of qa_data.json:
...
#      field: "status")
#
# Produces ONE combined pie chart across all 381 entries showing:
...
#
# Saves the chart to:
#   outputs_strict_batch_651_700/combined_hallucination_pie_chart.png
#
...
CHART_PATH            = "outputs_strict_batch_651_700/combined_hallucination_pie_chart.png"
...
# ── Load and combine all ten batches ───────────────────────────
...
ax.set_title(
    ...
    f"(28+23+26+48+50+50+49+47+30+30 entries across ten batches, "
    f"{skipped} skipped)\n"
