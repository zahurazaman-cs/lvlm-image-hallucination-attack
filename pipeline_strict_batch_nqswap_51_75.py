# ============================================================
# pipeline_strict_batch_nqswap_51_75.py — NQ-Swap Real-World
# Dataset, Third Batch of 25 (Entries 51-75)
# ============================================================
# Same 10-step design used across all qa_data.json (HaluEval)
# batches, now run on entries 50-74 of the NQ-Swap real-world
...
# binary scheme by mistake; this and all subsequent NQ-Swap
# batches are on the correct scheme).
#
import os
import json
import base64
...
BATCH_INDICES = list(range(50, 75))

BASE_OUTPUT_DIR = "outputs_strict_batch_nqswap_51_75"
...
print(f"\n{'='*65}")
print(f"PIPELINE_STRICT_BATCH_NQSWAP_51_75 COMPLETE — {total_time:.1f}s this run")
print(f"{'='*65}")
for r in results:
    print(
...
report_lines = [
    "="*65,
    "PIPELINE_STRICT_BATCH_NQSWAP_51_75 — FINAL REPORT",
    "="*65,
