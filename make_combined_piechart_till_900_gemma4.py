# ============================================================
# make_combined_piechart_till_900_gemma4.py
# ============================================================
# Combines FINAL-ITERATION results from ALL FOURTEEN strict batch
# runs (Gemma-4-abliterated as victim + judge, Qwen-Image-Edit-2509
# as image generator) covering lines 1-900 of qa_data.json:
...
#      field: "status")
#   - outputs_strict_batch_651_700/SUMMARY.json
#     (30 entries, classified NATIVELY during the run,
#      field: "status")
#   - outputs_strict_batch_701_750/SUMMARY.json
#     (30 entries, classified NATIVELY during the run,
#      field: "status")
#   - outputs_strict_batch_751_800/SUMMARY.json
#     (30 entries, classified NATIVELY during the run,
#      field: "status")
#   - outputs_strict_batch_801_850/SUMMARY.json
#     (30 entries, classified NATIVELY during the run,
#      field: "status")
#   - outputs_strict_batch_851_900/SUMMARY.json
#     (30 entries, classified NATIVELY during the run,
#      field: "status")
#
...
#
# Saves the chart to:
#   outputs_strict_batch_851_900/combined_hallucination_pie_chart.png
#
...
BATCH_651_700_SUMMARY = "outputs_strict_batch_651_700/SUMMARY.json"
BATCH_701_750_SUMMARY = "outputs_strict_batch_701_750/SUMMARY.json"
BATCH_751_800_SUMMARY = "outputs_strict_batch_751_800/SUMMARY.json"
BATCH_801_850_SUMMARY = "outputs_strict_batch_801_850/SUMMARY.json"
BATCH_851_900_SUMMARY = "outputs_strict_batch_851_900/SUMMARY.json"
CHART_PATH            = "outputs_strict_batch_851_900/combined_hallucination_pie_chart.png"
...
# ── Load and combine all fourteen batches ──────────────────────
...
categories_651 = load_native_batch(BATCH_651_700_SUMMARY)
categories_701 = load_native_batch(BATCH_701_750_SUMMARY)
categories_751 = load_native_batch(BATCH_751_800_SUMMARY)
categories_801 = load_native_batch(BATCH_801_850_SUMMARY)
categories_851 = load_native_batch(BATCH_851_900_SUMMARY)
all_categories = (categories_28 + categories_50 + categories_151
                   ...
                   + categories_651 + categories_701 + categories_751
                   + categories_801 + categories_851)
...
print(f"Batch 651-700 entries     : {len(categories_651)}")
print(f"Batch 701-750 entries     : {len(categories_701)}")
print(f"Batch 751-800 entries     : {len(categories_751)}")
print(f"Batch 801-850 entries     : {len(categories_801)}")
print(f"Batch 851-900 entries     : {len(categories_851)}")
