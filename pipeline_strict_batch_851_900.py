# ============================================================
# pipeline_strict_batch_851_900.py — Strict Pipeline, Lines 851-900
# ============================================================
# Scans lines 851-900 of qa_data.json for human-celebrity entries —
...
# abstract facts. 34 qualifying entries were found; trimmed to the
...
#
# Output directory: outputs_strict_batch_851_900
# ============================================================
...
# entries identified within lines 851-900 (trimmed down from 34
# originally found, dropping the 4 most obscure/moderate ones to
# match the requested batch size of 30).
#
#   line#(1-idx) -> subject
#   852 -> Clarence Brown / Peter Glenville (directors)
#   853 -> John Anthony Randle (NFL Hall of Famer)
#   854 -> Kim Jee-woon (director)
#   855 -> Peter Garrett / Ryo Kawakita (musicians)
#   856 -> John Dyer Baizley (musician)
#   857 -> Julian Clary (comedian)
#   859 -> Ron Kovic (activist/veteran)
#   860 -> Eric Whitacre (composer)
#   861 -> Dean Jones (actor)
#   865 -> Ted Tetzlaff / David Siegel (directors)
#   866 -> J. F. Lawton / Shawn Levy (filmmakers)
#   868 -> David Bowie (musician)
#   871 -> Björk (musician)
#   872 -> Otryadyn Gündegmaa (Olympic shooter)
#   873 -> Ettore Forti / Lawrence Alma-Tadema (painters)
#   874 -> Steven Tyler / Joe Perry (musicians)
#   875 -> Joe Barton (politician)
#   876 -> Vladimir Yaroshenko / Yury Grigorovich (ballet dancers)
#   877 -> Martha Graham (choreographer)
#   879 -> Jens Lehmann / Patrick Vieira (footballers)
#   881 -> Sam Claflin (actor)
#   886 -> Kim Ki-bum / Key (singer/actor)
#   887 -> King Charles / Charles Costa (musician)
#   888 -> Ray Winstone (actor)
#   889 -> Abigail Breslin / Brittany Snow
#   890 -> Gregg Berhalter (soccer coach)
#   893 -> Paul McCartney (musician)
#   894 -> Victor Estrada (Olympic medalist)
#   897 -> Scott Speedman (actor)
#   898 -> Patsy Cline / Randy Hughes (musician)
BATCH_INDICES = [
    852, 853, 854, 855, 856, 857, 859, 860, 861, 865, 866, 868,
    871, 872, 873, 874, 875, 876, 877, 879, 881, 886, 887, 888,
    889, 890, 893, 894, 897, 898
]

BASE_OUTPUT_DIR = "outputs_strict_batch_851_900"
...
print(f"\n{'='*65}")
print(f"PIPELINE_STRICT_BATCH_851_900 COMPLETE — {total_time:.1f}s this run")
print(f"{'='*65}")
for r in results:
    print(
...
report_lines = [
    "="*65,
    "PIPELINE_STRICT_BATCH_851_900 — FINAL REPORT",
    "="*65,
