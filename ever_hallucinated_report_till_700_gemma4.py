# ============================================================
# ever_hallucinated_report_till_700_gemma4.py
# ============================================================
# Scans EVERY iteration's Step 9 classification file (not just the
# final one) across all TEN strict batches (Gemma-4-abliterated as
# victim + judge, Qwen-Image-Edit-2509 as image generator), covering
# lines 1-700 of qa_data.json, and reports TWO statistics side by
# side:
#
...
#
# Reads iteration files from all ten batch directories:
#   outputs_strict_batch_28, _50, _151_200, _201_280, _281_360,
#   _361_440_combined, _441_520, _521_600, _601_650, _651_700
#
# Writes:
#   EVER_HALLUCINATED_REPORT_till_700_gemma4.txt (in the current
#   directory)
# ============================================================
...
with open("EVER_HALLUCINATED_REPORT_till_700_gemma4.txt", "w") as f:
    f.write(report_text)

print("\nSaved report to: EVER_HALLUCINATED_REPORT_till_700_gemma4.txt")
