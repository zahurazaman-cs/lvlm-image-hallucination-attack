# ============================================================
# pipeline_strict_batch_751_800.py — Strict Pipeline, Lines 751-800
# ============================================================
# Scans lines 751-800 of qa_data.json for human-celebrity entries —
...
# abstract facts. 33 qualifying entries were found; trimmed to the
...
#
# Output directory: outputs_strict_batch_751_800
# ============================================================
...
# entries identified within lines 751-800 (trimmed down from 33
# originally found, dropping the 3 most obscure/moderate ones to
# match the requested batch size of 30).
#
#   line#(1-idx) -> subject
#   751 -> Ruta Sepetys (author)
#   753 -> Obafemi Martins (footballer)
#   756 -> James Agee / Nelly Sachs (writer/poet)
#   757 -> Yoon Sang-hyun (actor)
#   759 -> Chris Shiflett (musician)
#   760 -> Lily Tomlin / Betty White
#   761 -> Ronald Reagan (via documentary entry)
#   762 -> Del Lord / Wang Xiaoshuai (directors)
#   767 -> Gregory Hines / Mikhail Baryshnikov
#   768 -> Steve Jones / Blag Dahlia (musicians)
#   772 -> Serj Tankian (musician)
#   773 -> Chris Petersen (football coach)
#   774 -> Debbie Harry / Chris Stein (Blondie)
#   775 -> Randall Park (actor)
#   777 -> Claire Denis (director)
#   778 -> 21 Savage (rapper)
#   779 -> Boban Rajović (singer)
#   780 -> David Jason / Sean Astin
#   781 -> Elliot Goldenthal (composer)
#   782 -> Sammy Wilson (politician)
#   785 -> Vikram Seth (author)
#   786 -> Jay Joyce (music producer)
#   789 -> Cody Linley / Julianne Hough
#   790 -> Joël Robuchon (chef)
#   791 -> Gino Cassinis / Luigi Einaudi (historical figures)
#   792 -> Colin Morgan (actor)
#   795 -> Erik Paulsen (politician)
#   796 -> Howard Hawks / Arthur Berthelet (directors)
#   799 -> Steve Daines / Amanda Curtis (politicians)
#   800 -> Blanck Mass / Benjamin John Power (musician)
BATCH_INDICES = [
    750, 752, 755, 756, 758, 759, 760, 761, 766, 767, 771, 772,
    773, 774, 776, 777, 778, 779, 780, 781, 784, 785, 788, 789,
    790, 791, 794, 795, 798, 799
]

BASE_OUTPUT_DIR = "outputs_strict_batch_751_800"
...
print(f"\n{'='*65}")
print(f"PIPELINE_STRICT_BATCH_751_800 COMPLETE — {total_time:.1f}s this run")
print(f"{'='*65}")
for r in results:
    print(
...
report_lines = [
    "="*65,
    "PIPELINE_STRICT_BATCH_751_800 — FINAL REPORT",
    "="*65,
