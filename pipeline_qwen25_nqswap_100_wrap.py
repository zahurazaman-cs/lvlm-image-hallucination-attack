# ============================================================
# pipeline_qwen25_nqswap_100_wrap.py
# ============================================================
# Tests whether the wrap-around Step 8 defense prompt (short
# CAUTION before the ORIGINAL unchanged instructions, short
# REMINDER after — the same one validated on both qa_data.json
# and Gemma-on-NQ-Swap) also works when QWEN2.5-VL is the victim
# being reprompted, on the same 100 NQ-Swap entries.
#
...
#            images, with the SAME fixed wrap-around prompt used
#            in every other defense experiment. ONE pass per entry.
...
OUTPUT_DIR = "outputs_qwen25_nqswap_100_wrap"
STATE_PATH = f"{OUTPUT_DIR}/entry_state.json"

SOURCE_STATE_PATH = "outputs_victim_qwen_nqswap_100/entry_state.json"

# The exact same fixed CAUTION/REMINDER pair used in every other
# defense experiment in this project
...
print(f"\n{'='*65}")
print(f"NQ-SWAP 100 — Qwen2.5-VL DEFENSE WRAP TEST")
...
print(f"\n{'='*65}")
print("NQ-SWAP 100 — Qwen2.5-VL DEFENSE WRAP — FINAL SUMMARY")
print(f"{'='*65}")
