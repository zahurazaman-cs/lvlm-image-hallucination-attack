...
# BATCH: Qwen3.5 victim-model comparison — same 28 entries as
# outputs_strict_batch_28 / outputs_victim_qwen_28, for direct
# three-way comparison: Gemma vs. Qwen2.5-VL vs. Qwen3.5 as victim.
BATCH_INDICES = [
...
VICTIM_MODEL    = "qwen3.5:9b"                      # Step 8 ONLY — third comparison arm
