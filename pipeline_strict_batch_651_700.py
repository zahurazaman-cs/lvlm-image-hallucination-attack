# ============================================================
# pipeline_strict_batch_651_700.py — Strict Pipeline, Lines 651-700
# ============================================================
# Scans lines 651-700 of qa_data.json for human-celebrity entries —
...
# abstract facts. 35 qualifying entries were found; trimmed to the
# strongest 30 (dropping the most obscure/moderate ones) to match
# the requested batch size of 30.
#
...
#
# Output directory: outputs_strict_batch_651_700
# ============================================================
...
# 0-indexed line numbers in qa_data.json for the 30 human-celebrity
# entries identified within lines 651-700 (trimmed down from 35
# originally found, dropping the 5 most obscure/moderate ones to
# match the requested batch size of 30).
#
#   line#(1-idx) -> subject
#   651 -> Molly Hagan (actress)
#   653 -> Chris Vance / Jason Statham (actors)
#   654 -> Marcia Wallace (actress/voice actor)
#   655 -> Kim Warwick / Matt Lucena (tennis players)
#   656 -> Lucy Maud Montgomery / Jan Karon (authors)
#   657 -> Keisha Castle-Hughes (actress)
#   658 -> Esperanza Baur / John Wayne
#   660 -> Stephen Frears (director)
#   661 -> Björn Ulvaeus / Benny Andersson (ABBA)
#   662 -> Lisa Randall (physicist)
#   665 -> Vishwa Mohan Bhatt (musician)
#   666 -> Hal McRae (baseball player)
#   670 -> Queen Alexandrine (historical figure)
#   671 -> Oprah Winfrey
#   672 -> Alan Sokal / Jean Bricmont (academics/authors)
#   673 -> Mathilde Ludendorff / Erich Ludendorff (historical figures)
#   675 -> Lee Mi-sook (actress)
#   677 -> Brothers Quay / Alexandra Shiva (filmmakers)
#   678 -> Katey Sagal / John Ritter
#   679 -> Marco Garibaldi / Priscilla Presley
#   680 -> Lars Onsager (historical Nobel chemist)
#   681 -> American Horse (historical chief)
#   684 -> Stephen Devassy (musician)
#   688 -> Michael Beasley / Bruce Weber
#   689 -> Rene Russo / Robbie Coltrane
#   692 -> Riccardo Cocchi / Yulia Zagoruychenko (dance champions)
#   693 -> Viktor Bout (arms dealer)
#   695 -> Leon Lai / Donnie Yen / Tsui Hark
#   698 -> Tressie Souders / Padmarajan (directors)
#   700 -> Peter Chelsom / Billy Bob Thornton
BATCH_INDICES = [
    650, 652, 653, 654, 655, 656, 657, 659, 660, 661, 664, 665,
    669, 670, 671, 672, 674, 676, 677, 678, 679, 680, 683, 687,
    688, 691, 692, 694, 697, 699
]

BASE_OUTPUT_DIR = "outputs_strict_batch_651_700"
...
print(f"\n{'='*65}")
print(f"PIPELINE_STRICT_BATCH_651_700 COMPLETE — {total_time:.1f}s this run")
print(f"{'='*65}")
for r in results:
    print(
...
report_lines = [
    "="*65,
    "PIPELINE_STRICT_BATCH_651_700 — FINAL REPORT",
    "="*65,
